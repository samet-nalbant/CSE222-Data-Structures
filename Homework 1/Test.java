...
public class Test{
    ...
    public static void addDefaults(Company x){
        ...
        customer1 = x.getCustomers().at(employee.findCustomer(0));
        ...
        if(x.adminLogIn(mail, password)){
            ...
            while(choice != 0){
                ...
                switch (choice) {
                    ...
                    case 2:
                        temp.showBranchs();
                        if(temp.getCompany().getBranchs().getSize() != 0){
                            System.out.println("Enter the number of the Branch to Show Employees.");
                            selection = input.nextInt();
                            try {
                                temp.showBranchEmployees(temp.getCompany().getBranchs().at(selection-1).getName());
                            } catch (Exception e) {
                    ...
                    case 4:
                        ...
                        input.nextLine();
                        selection = input.nextInt();
                        if(selection <= 0 || selection > temp.getCompany().getBranchs().getSize() || temp.removeBranch(new Branch(temp.getCompany().getBranchs().at(selection-1).getName())) == false){
                    ...
                    case 5:
                        ...
                        selection = input.nextInt();
                        if(selection <= 0 || selection > temp.getCompany().getBranchs().getSize()){
                            System.out.println("Branch couldn't found!\n");
                        }
                        else{
                            input.nextLine();
                            ...
                            password = input.nextLine();                                    
                            if(!(temp.addEmployee(name,surname,mail,password,temp.getCompany().getBranchs().at(selection-1).getName()))){
                    ...
                    case 6:
                        ...
                        if(selection <= 0 || selection > temp.getCompany().getBranchs().getSize()){
                            ...
                            num = input.nextInt();
                            if(num <= 0 || num >temp.getCompany().getBranchs().at(selection-1).getEmployees().getSize()){
                                System.out.println("Wrong Selection!");
                            }
                            else{
                                if(temp.removeEmployee(temp.getCompany().getBranchs().at(selection-1).getEmployees().at(num-1),temp.getCompany().getBranchs().at(selection-1).getName())){
                                    System.out.println("Operation Succesful!");
                                }
                                else{
            ...
            while(selection != 0){
                ...
                switch (selection){
                    ...
                    case 2:
                        ...
                        num = input.nextInt();
                        if(num <=0 || tempEmployee.getBranch().getProducts().getSize() < num){
                            System.out.println("Wrong Selection!");
                        }
                        else{
                            tempEmployee.removeProduct(tempEmployee.getBranch().getProducts().at(num-1));
                            System.out.println("Operation Succesful!");
                        }
                        break;
                    case 3:
                        ...
                        if(num <=0 || tempEmployee.getBranch().getProducts().getSize() < num){
                            ...
                            if(amount <=0){
                                ...
                                tempEmployee.makeSale(id, phone, adress, tempEmployee.getBranch().getProducts().at(num-1), amount);
                            }
    ...
    public static void customerMenu(Company x){
        ...
        if(x.customerLogIn(mail, password) == true){
            System.out.println("Succesfully Loged In\n");
            tempCustomer = x.getCustomers().at(x.getCustomers().containsElement(new Customer(" "," ",mail,password,null)));
            while(choice != 0){
                ...
                switch (choice){
                    ...
                    case 3:
                        ...
                        if(num <=0 || num > x.getAvailableProductsAmount()){
                            ...
                            phone = input.nextLine();
                            if(!(tempCustomer.shopOnline(x.getStocks().at(num-1), amount, adress, phone))){
